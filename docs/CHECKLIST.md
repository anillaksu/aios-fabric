...
- [x] W6.L ✅ **FACT (2026-08-18) — canlı kanıtlandı.** Prompt→kod önbelleği. SHA-256 (`crypto.subtle`) ile eşleme; normalizasyon zorunlu, hash'e capability sürümü katılır.
      ...
      · **7 test** (`prompt-cache.test.ts`): normalizasyon kelime silmiyor (bilinçli), Unicode NFKC eşdeğerliği, anahtar deterministik, risk değişince anahtar değişiyor, capability seti değişince anahtar değişiyor, sıra anahtarı etkilemiyor
