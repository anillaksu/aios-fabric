...
$SCP "$REPO"/scripts/start_hermes_os.sh "$REPO"/scripts/watchdog.sh "$REPO"/scripts/10-aios.sh "$REPO"/scripts/provision-fabric-gateway-key.sh "$REPO"/scripts/aios-admin-console.sh "$REPO"/scripts/aios-workspace-map.sh "$REPO"/scripts/aios-connectivity-bridge.sh "$REPO"/scripts/aios-runtime-ledger.sh "$PHONE":'~/' || fail "kanonik baslaticilar kopyalanamadi"
$SSH "$PHONE" 'mkdir -p ~/.shortcuts ~/.termux/boot && cp ~/start_hermes_os.sh ~/.shortcuts/start_hermes_os.sh && cp ~/10-aios.sh ~/.termux/boot/10-aios.sh && cp ~/provision-fabric-gateway-key.sh ~/.shortcuts/provision-fabric-gateway-key.sh && cp ~/aios-admin-console.sh ~/.shortcuts/aios-admin-console.sh && cp ~/aios-workspace-map.sh ~/.shortcuts/aios-workspace-map.sh && cp ~/aios-connectivity-bridge.sh ~/.shortcuts/aios-connectivity-bridge.sh && cp ~/aios-runtime-ledger.sh ~/.shortcuts/aios-runtime-ledger.sh && chmod 700 ~/start_hermes_os.sh ~/watchdog.sh ~/aios-runtime-ledger.sh ~/.shortcuts/start_hermes_os.sh ~/.shortcuts/provision-fabric-gateway-key.sh ~/.shortcuts/aios-admin-console.sh ~/.shortcuts/aios-workspace-map.sh ~/.shortcuts/aios-connectivity-bridge.sh ~/.shortcuts/aios-runtime-ledger.sh ~/.termux/boot/10-aios.sh' || fail "Widget/boot baslaticilari hazirlanamadi"
